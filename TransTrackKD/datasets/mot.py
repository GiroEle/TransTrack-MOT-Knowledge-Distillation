...
#                     T.RandomSizeCrop(384, 600),
    ...
    if image_set == 'train_KD' and not args.eval:
        return T.Compose([
            T.RandomHorizontalFlip(),
            T.RandomSelect(
                T.RandomResize(scales, max_size=1333),
...
#                     T.RandomSizeCrop(384, 600),
    ...
    if image_set == 'val_KD' or args.eval:
        return T.Compose([
            T.RandomResize([800], max_size=1333),
            normalize,
        ])
...
def build(image_set, args):
    ...
    PATHS = {
        ...
        #giro: For KD
        "train_KD": (root / "train", root / "annotations_KD" / 'train_half_KD.json'),
        "val_KD": (root / "train", root / "annotations_KD" / 'val_half_KD.json'),
