...
def main(args):
    ...
    #while res and time.time()-time_first_start < 219:
    #while res and time.time()-time_first_start < 100:
    while res and count<max_frames:
        ...
        fps_list.append(1/(time.time()-time_start))
        #eval_output[count-1][0]=time.time()-time_start
        ...
        curr_time=time.time()
        """
        #eval_output[count-1][2]=time.time()-curr_time
