...
from engine_track_AnnGen import evaluate, train_one_epoch
from models import build_tracktrain_model, build_tracktest_model, build_model
from models import Tracker
from models import save_track_AnnGen
...
def main(args):
    ...
    if args.distributed:
        ...
        #giro: made sequential to evaluate soft targets using pre-embed
...
#             )
    ...
    if args.eval:
        ...
        test_stats, coco_evaluator, res_tracks = evaluate(model, criterion, postprocessors, data_loader_train,
                                                         base_ds, device, args.output_dir, tracker=tracker, 
                                                         phase='eval', det_val=args.det_val, fp16=args.fp16)
        if args.output_dir:
#             utils.save_on_master(coco_evaluator.coco_eval["bbox"].eval, output_dir / "eval.pth")
            if res_tracks is not None:
                ...
                # save mot results.
                save_track_AnnGen(res_tracks, args.output_dir, video_to_images, video_names, 'KD_eval')
